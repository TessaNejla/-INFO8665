...
# Button to display predicted prices
predicted_prices_button = pn.widgets.Button(name='Display Predicted Prices', button_type='primary')

# Callback function for predicted prices button click
def predicted_prices_button_click(event):
    additional_info_pane.clear()
    for selected_stock in ticker_select.value:
        additional_info_pane.append(display_predicted_prices(selected_stock, start_date_picker.value, end_date_picker.value))

# Assign callback to predicted prices button
predicted_prices_button.on_click(predicted_prices_button_click)
...
main_layout = pn.Column(
    ...
    pn.Row(
        ...
        pn.Column(additional_info, summary_button, predicted_prices_button)
    ),
    pn.Tabs(
